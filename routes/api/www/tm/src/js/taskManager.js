    ...
    return {
	 token: function() {
        ...
        complete: function () {
           ...
           let liStorage = JSON.parse(mongoManager.getOneElem(this));
           if(liStorage.taskIsComplete === false) {
		   liStorage.taskIsComplete = true;
               //mongoManager.completeElem.complete(this);
               mongoManager.refactorElem(this, this, liStorage);
		   li.classList.remove(li.classList[5]);
               	li.classList.add('green');
           } else {
		   liStorage.taskIsComplete = false;
              // mongoManager.completeElem.inProgress(this);
               mongoManager.refactorElem(this, this, liStorage);
		   li.remove();
               liStorage = JSON.parse(mongoManager.getOneElem(this));
               taskManager.create(liStorage);
           }
        ...
        set: function () {
            ...
            if (document.querySelector('#taskName').value !== "") {
                ...
                mongoManager.refactorElem(this, newTask.taskName, newTask);
                taskManager.clearForm();
        ...
        createList: function() {
                let list = JSON.parse(mongoManager.getAllElems());
        ...
        createCustomList: function(listname) {
            let customList = JSON.parse(mongoManager.getAllElems());

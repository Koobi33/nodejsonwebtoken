function ready() {
  var token = taskManager.token();
	if(!token) {
		window.location.href = "http://35.204.124.30:3012/api/auth";
	}
    ...
    document.addEventListener('click', function (e) {
        ...
        if (tar.classList.contains("formToggle")) { //если кликнули на "создать задачу"
            ...
            taskManager.complete.apply(tar.parentElement.parentElement.id)
        }  else if (tar.classList.contains('basic')) {
